...
const textoInicial = document.getElementById("texto__entrada");
const textFinal = document.getElementById("texto__final");
const munheco = document.getElementById("dibujo");
const textInfo = document.getElementById("texto__informacion");
const rigth = document.getElementById("seccion__salida")
